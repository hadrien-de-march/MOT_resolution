...
#    grid.impl_psi = implied[1]
    ...
    grid = Class_grid.Grid(dim = d, stepsX = stepsX, stepsY = stepsY, boundX = boundX, boundY = boundY,
...
#    grid2 = Class_grid.Grid(dim = d, stepsX = stepsX, stepsY = stepsY, boundX = boundX, boundY = boundY,
#               epsilon = epsilon,
#               cost = None,
